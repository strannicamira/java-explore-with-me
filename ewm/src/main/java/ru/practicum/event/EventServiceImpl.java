...
public class EventServiceImpl implements EventService {
    ...
    public EventFullDto createEvent(NewEventRequest newEventRequest, Integer userId) {
        ...
        Event event = eventRepository.save(EventMapper.mapToEvent(newEventRequest, location));
        ...
        EventFullDto eventFullDto = EventMapper.mapToEventFullDto(event, categoryById,
